<template>
    <section>
        ...
        <div class="orderTab">
        	<dl>
            	<dd @click="swichRouter" class="tabCur"><a>店铺订单</a></dd>
                <dd @click="swichRouter"><a>小程序订单</a></dd>
            </dl>
        </div>
                ...
                <div v-infinite-scroll="loadMore" infinite-scroll-disabled="loading" infinite-scroll-distance="30">
                  <div class="orderListCon" v-show="orderContent.length>0" v-for="(ol,i) in orderContent" :key="i">
                    <div class="orderConTit">
                        ...
                        <a :href="'#/order/detail?orderid='+ol.order.mtOrderId" class="orderDetailBtn">订单详情</a>
                    </div> 
                    <dl>
